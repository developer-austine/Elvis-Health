		...
		init: function () {
			...
			jQuery("#menu").length > 0 && $("#menu").metisMenu(),
				...
				$("ul#menu>li").on("click", function () {
					"mini" === $("body").attr("data-sidebar-style") &&
						(console.log($(this).find("ul")), $(this).find("ul").stop());
				}),
				(n = window.outerHeight),
				((n = window.outerHeight) > 0 ? n : screen.height) &&
				...
				jQuery(".dlabnav-scroll").length > 0 &&
					(new PerfectScrollbar(".dlabnav-scroll").isRtl = !1),
				...
				jQuery(".show-pass").on("click", function () {
					jQuery(this).toggleClass("active"),
						"password" == jQuery("#dlab-password").attr("type")
							? jQuery("#dlab-password").attr("type", "text")
							: "text" == jQuery("#dlab-password").attr("type") &&
				...
				jQuery("#datetimepicker1").length > 0 &&
					$("#datetimepicker1").datetimepicker({ inline: !0 }),
		...
		handleMenuPosition: function () {
			e > 1024 &&
				$(".metismenu  li")
					...
					.each(function (e) {
						if ($("ul", this).length > 0) {
							var t = (a = $("ul:first", this).css("display", "block")).offset()
									.left,
								n = a.width(),
